					...
					<div class="card-body">
						...
						<form action="processform" method="post">
							...
							<div class="form-group">
    							...
    							<input type="text" name="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Your DOB">
  							</div>
  							<div class="form-group">
    							<label for="exampleFormControlSelect1">Select Courses</label>
    							<select multiple class="form-control" name="courses" id="exampleFormControlSelect1">
      								<option>Java</option>
